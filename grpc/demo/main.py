...
def main():
    ...
    #images_demo(model,"/home/samuel/projects/All-In-One/grpc/test/test-images/",detector)
    #webcam_demo(model,detector)
    #video_demo(model,"/home/samuel/projects/All-In-One/grpc/test/test_videos/video_demo2.mp4",detector)
